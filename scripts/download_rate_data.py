...
fed_funds_url = (
    f"https://fred.stlouisfed.org/graph/fredgraph.csv?id=DFF&cosd={start_date}&coed={end_date}"
)

treasury_2y_url = (
    f"https://fred.stlouisfed.org/graph/fredgraph.csv?id=DGS2&cosd={start_date}&coed={end_date}"
)

treasury_10y_url = (
    f"https://fred.stlouisfed.org/graph/fredgraph.csv?id=DGS10&cosd={start_date}&coed={end_date}"
)
